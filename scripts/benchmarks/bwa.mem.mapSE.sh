...
echo "==> Mapping $OUT_T1"
profile "./bwa mem -t $num_threads $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $local_results_path/$OUT_T1.sam 2> $log_path/$OUT_T1.log"
