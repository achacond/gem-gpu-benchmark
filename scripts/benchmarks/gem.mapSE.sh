...
echo "==> Mapping $OUT_T1"
profile "bin/gem-mapper -I $local_index_path/HG_index_GEM3_default/hsapiens_v37.gem -i $local_dataset_path/SE.DUMMY.fastq -o $local_results_path/$OUT_T1.sam > $log_path/$OUT_T1.log 2>&1"
...
echo "==> Mapping $OUT_T2"
profile "bin/gem-mapper -I $local_index_path/HG_index_GEM3_default/hsapiens_v37.gem -i $local_dataset_path/$IN.fastq -o $local_results_path/$OUT_T2.sam > $log_path/$OUT_T2.log 2>&1"
...
echo "==> Mapping $OUT_T3"
profile "bin/gem-mapper --cuda -I $local_index_path/HG_index_GEM3_default/hsapiens_v37.gem -i $local_dataset_path/$IN.fastq -o $local_results_path/$OUT_T3.sam > $log_path/$OUT_T3.log 2>&1"
