...
#SBATCH --output=../../logs/BWA.PE.mapping.summary.log 
#SBATCH --error=../../logs/BWA.PE.mapping.summary.log
...
mkdir -p $log_path
#mkdir $local_path/HG_index_BWA_default
...
echo "==> Mapping $OUT_T1"
profile "./bwa mem -p $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $local_results_path/$OUT_T1.sam 2> $log_path/$OUT_T1.log"
...
echo "==> Mapping $OUT_T2"
profile "./bwa mem -p -t $num_threads $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $local_results_path/$OUT_T2.sam 2> $log_path/$OUT_T2.log"

OUT_T3="$TAG.$OUT_PREFIX.c500.t$num_threads"
echo "==> Mapping $OUT_T3"
profile "./bwa mem -p -t $num_threads -c 500 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $local_results_path/$OUT_T3.sam 2> $log_path/$OUT_T3.log"


OUT_T4="$TAG.$OUT_PREFIX.c1000.t$num_threads"
echo "==> Mapping $OUT_T4"
profile "./bwa mem -p -t $num_threads -c 1000 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $local_results_path/$OUT_T4.sam 2> $log_path/$OUT_T4.log"


OUT_T5="$TAG.$OUT_PREFIX.c16000.t$num_threads"
echo "==> Mapping $OUT_T5"
profile "./bwa mem -p -t $num_threads -c 16000 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $local_results_path/$OUT_T5.sam 2> $log_path/$OUT_T5.log"


OUT_T6="$TAG.$OUT_PREFIX.c20000.k16.t$num_threads"
echo "==> Mapping $OUT_T6"
profile "./bwa mem -p -t $num_threads -k 16 -c 20000 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $local_results_path/$OUT_T6.sam 2> $log_path/$OUT_T6.log"
