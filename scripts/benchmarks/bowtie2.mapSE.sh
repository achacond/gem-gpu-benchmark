...
echo "==> Mapping $OUT_T1"
profile "./bowtie2 --threads $num_threads -x $local_index_path/HG_index_bowtie2_default/hsapiens -U $local_dataset_path/SE.DUMMY.fastq -S $local_results_path/$OUT_T1.sam > $log_path/$OUT_T1.log 2>&1"
