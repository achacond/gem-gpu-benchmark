...
echo "==> Mapping $OUT_T1"
profile "./soap3-dp pair $local_index_path/HG_index_soap3-dp_default/hsapiens_v37.fa.index $local_dataset_path/$IN.1.fastq $local_dataset_path/$IN.2.fastq -o $local_results_path/$OUT_T1.sam -L $max_query_size -c 0 > $log_path/$OUT_T1.log 2>&1"
